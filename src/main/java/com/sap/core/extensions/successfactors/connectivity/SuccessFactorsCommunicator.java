...
public class SuccessFactorsCommunicator {
	...
	private static final String USER_PROGAGATION_DESTINATION_NAME = "SFOAuthXXX";
	private static final String TECHNICAL_USER_DESTINATION_NAME = "SFOAuth_SYSTEMXXXX";
